...
<div class="span5">
    ...
    echo form_open('admin/invigilators/addinvigilator', $attributes);
    ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="password" id="password" placeholder="username" value="<?php echo set_value('password'); ?>"> 
        </div> 
    </div>
